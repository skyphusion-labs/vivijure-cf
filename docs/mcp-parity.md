...
| `POST` | `/api/cast/:id/voice-sample` | yes | -- | json |
| `GET` | `/api/cast/:id/voice-sample` | yes | -- | json |
| `POST` | `/api/cast/:id/voice-sample/keep` | yes | -- | json |
| `POST` | `/api/cast/:id/voice-sample/attach` | yes | -- | json or raw video/audio |
| `DELETE` | `/api/cast/:id/voice-sample` | yes | -- | json |
