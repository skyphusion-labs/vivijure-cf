...
async function doorsFor(env: Env): Promise<DoorRoute[]> {
  ...
  return doorPool([
    { name: DOOR_ROUTE_NAME, baseUrl: DOOR_ORIGIN["finish-upscale"].fatmike, token: legacyToken, legacy: true },
    { name: doorName("propagandhi"), baseUrl: DOOR_ORIGIN["finish-upscale"].propagandhi, token: propagandhiToken },
  ]);
}
