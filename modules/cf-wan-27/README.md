...
Unified Billing (`alibaba/wan-2.7-i2v`). Turns one shot's start keyframe into a clip with **no RunPod**.
...
- **Service**: `vivijure-module-cf-wan-27` bound as `MODULE_CF_WAN_27`.
...
Account live rates: [CF dashboard · alibaba/wan-2.7-i2v](https://dash.cloudflare.com/?to=/:account/ai/models/alibaba/wan-2.7-i2v).
