...
Unified Billing (`minimax/hailuo-2.3`). Turns one shot's start keyframe into a clip with **no RunPod**.
...
- **Service**: `vivijure-module-cf-hailuo` bound as `MODULE_CF_HAILUO`.
...
Account live rates: [CF dashboard · minimax/hailuo-2.3](https://dash.cloudflare.com/?to=/:account/ai/models/minimax/hailuo-2.3).
