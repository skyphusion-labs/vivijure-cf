...
dashboard-controlled; `apply-waf.sh` is the record and the mechanism. This directory rides with the
control plane if cf#85 extracts it to `vivijure-control-plane`.
